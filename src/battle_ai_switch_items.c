...
static u32 CalculateHazardDamage(void)
{
    ...
    if (gBattleMons[gActiveBattler].ability == ABILITY_MAGIC_GUARD || gBattleMons[gActiveBattler].ability == ABILITY_WONDER_GUARD || holdEffect == HOLD_EFFECT_HEAVY_DUTY_BOOTS)
