...
void ShowScrollableMultichoice(void)
{
    ...
    switch (gSpecialVar_0x8004)
    {
        ...
        case SCROLL_MULTI_PC_TUTOR_SET_7:
            ...
            task->tTaskId = taskId;
            break;
        case SCROLL_MULTI_PC_TUTOR_SET_SELECT_FEATHER:
        case SCROLL_MULTI_PC_TUTOR_SET_SELECT:
            task->tMaxItemsOnScreen = MAX_SCROLL_MULTI_ON_SCREEN;
            task->tNumItems = (gSpecialVar_0x8004 == SCROLL_MULTI_PC_TUTOR_SET_SELECT) ? 8 : 7;
            task->tLeft = 19;
            task->tTop = 1;
            task->tWidth = 12;
            task->tHeight = 12;
...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] = 
{
    ...
    [SCROLL_MULTI_PC_TUTOR_SET_SELECT_FEATHER] =
    {
        gText_TutorMoveSet1,
        gText_TutorMoveSet2,
        gText_TutorMoveSet3,
