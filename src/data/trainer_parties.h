...
static const struct TrainerMonItemCustomMoves sParty_WallyVR2[] = {
    ...
    .moves = MOVE_MEGA_DRAIN, MOVE_ACID_SPRAY, MOVE_SLEEP_POWDER, MOVE_QUIVER_DANCE
    },
    {
    .lvl = 1,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLilycoveMudkip[] = {
    ...
    .moves = MOVE_SOLAR_BLADE, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_GROWTH
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne4[] = { // Doubles
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYPER_VOICE, MOVE_FREEZE_DRY, MOVE_EARTH_POWER, MOVE_ROCK_SLIDE
    },
    {
    .lvl = 0,
    .species = SPECIES_AERODACTYL,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly3[] = { // singles with legendaries
{
    ...
    .heldItem = ITEM_CHOICE_SPECS,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SCALD, MOVE_SECRET_SWORD, MOVE_ICY_WIND, MOVE_AIR_SLASH
    },
    {
    .lvl = 0,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly5[] = { // Doubles with legendaries
{
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FOLLOW_ME, MOVE_CLOSE_COMBAT, MOVE_METEOR_MASH, MOVE_EXTREME_SPEED
    },
    {
    .lvl = 0,
    .species = SPECIES_MARSHADOW,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = { // singles
    ...
    .heldItem = ITEM_LIFE_ORB,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ENERGY_BALL, MOVE_SILVER_WIND, MOVE_THUNDER, MOVE_STICKY_WEB
    },
    {
    .lvl = 0,
    .species = SPECIES_MAGNEZONE,
    ...
    .heldItem = ITEM_CHOICE_SCARF,
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_VOLT_SWITCH, MOVE_SCALD, MOVE_THUNDERBOLT, MOVE_TRICK
    },
    {
    .lvl = 0,
    .species = SPECIES_RAICHU_ALOLAN,
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_VOLT_SWITCH, MOVE_PSYSHOCK, MOVE_GRASS_KNOT, MOVE_SURF
    },
    {
    .lvl = 2,
    .species = SPECIES_MANECTRIC,
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_VOLT_SWITCH, MOVE_FLAMETHROWER, MOVE_AURORA_BEAM, MOVE_THUNDERBOLT
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson3[] = { //Legendaries
    ...
    .heldItem = ITEM_TERRAIN_EXTENDER,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_U_TURN, MOVE_PLAY_ROUGH, MOVE_WILD_CHARGE, MOVE_BRAVE_BIRD
    },
    {
    .lvl = 0,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson4[] = { // Doubles
    ...
    .heldItem = ITEM_CHOICE_SCARF,
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_VOLT_SWITCH, MOVE_ICY_WIND, MOVE_THUNDERBOLT, MOVE_TRICK
    },
    {
    .lvl = 0,
    .species = SPECIES_MAGNEZONE,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson5[] = { // Doubles
    ...
    .heldItem = ITEM_CHOICE_SCARF,
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_VOLT_SWITCH, MOVE_SURF, MOVE_THUNDERBOLT, MOVE_TRICK
    },
    {
    .lvl = 0,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_VOLT_SWITCH, MOVE_CHARGE_BEAM, MOVE_AURA_SPHERE, MOVE_AURORA_BEAM
    },
    {
    .lvl = 2,
    .species = SPECIES_MANECTRIC,
...
static const struct TrainerMonItemCustomMoves sParty_Courtney_MeteorFalls[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DARK_PULSE, MOVE_FLAMETHROWER, MOVE_SOLAR_BEAM, MOVE_SLUDGE_BOMB
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery2[] = { // singles
    ...
    .ability = 2, // Intimidate
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_SOLAR_BEAM, MOVE_NASTY_PLOT
    },
    {
    .lvl = 0,
    .species = SPECIES_ARCANINE,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery3[] = { // singles with legendaries
    ...
    .heldItem = ITEM_LIFE_ORB,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BLUE_FLARE, MOVE_DRACO_METEOR, MOVE_SOLAR_BEAM, MOVE_EARTH_POWER
    },
    {
    .lvl = 0,
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BRAVE_BIRD, MOVE_FLARE_BLITZ, MOVE_EARTHQUAKE, MOVE_DEFOG
    },
    {
    .lvl = 0,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery4[] = { // Doubles with legendaries
    ...
    .ability = 0, // Regenerator
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BRAVE_BIRD, MOVE_FLARE_BLITZ, MOVE_IRON_HEAD, MOVE_ROOST
    },
    {
    .lvl = 0,
    .species = SPECIES_VOLCANION,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery5[] = { // doubles
    ...
    .ability = 0, // Intimidate
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_HEAT_WAVE, MOVE_SNARL, MOVE_WILL_O_WISP, MOVE_PROTECT
    },
    {
    .lvl = 0,
    .species = SPECIES_VOLCARONA,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .ability = 1, // Rampage
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_GIGA_IMPACT, MOVE_EARTHQUAKE, MOVE_BODY_SLAM, MOVE_CLOSE_COMBAT
    },
    {
    .lvl = 0,
    .species = SPECIES_LINOONE,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_FACADE, MOVE_YAWN, MOVE_NIGHT_SLASH, MOVE_EARTHQUAKE
    },
    {
    .lvl = 0,
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = { // singles
    ...
    .ability = 2, // Sheer Force
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BODY_SLAM, MOVE_HIGH_HORSEPOWER, MOVE_THROAT_CHOP, MOVE_CLOSE_COMBAT
    },
    {
    .lvl = 0,
    .species = SPECIES_LINOONE,
...
static const struct TrainerMonItemCustomMoves sParty_Winona3[] = { // Doubles
{
    ...
    .ability = 2, // Cloud Nine
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYPER_VOICE, MOVE_FLAMETHROWER, MOVE_ROOST, MOVE_ICE_BEAM
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona4[] = { // Legendaries
    ...
    .species = SPECIES_ZAPDOS,
    .heldItem = ITEM_LEFTOVERS,
    .ability = 0, // Lightning Rod
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_HURRICANE, MOVE_THUNDERBOLT, MOVE_U_TURN, MOVE_ROOST
    },
    {
    .lvl = 0,
...
static const struct TrainerMonItemCustomMoves sParty_CourtneyMagmaHideout[] = {
    ...
    .ability = 2, // Drought
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HEAT_WAVE, MOVE_SHADOW_BALL, MOVE_SOLAR_BEAM, MOVE_HYPNOSIS
    },
    {
    .lvl = 1, 
    .species = SPECIES_KROOKODILE,
    ...
    .ability = 2, // Intimidate
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DARK_PULSE, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM, MOVE_SLUDGE_BOMB
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Matt[] = {
{
    ...
    .ability = 0, // Dry Skin
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDER, MOVE_WEATHER_BALL, MOVE_AURA_SPHERE, MOVE_GRASS_KNOT
    },
    {
    .lvl = 0,
    .species = SPECIES_TOXICROAK,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = { // Inverse Battle!
    ...
    .ability = 1, // Magic Guard
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_PSYCHIC, MOVE_AURA_SPHERE, MOVE_THUNDERBOLT, MOVE_CALM_MIND
    },
    {
    .lvl = 3,
    .species = SPECIES_LUNATONE,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza2[] = { // no legendaries
    ...
    .ability = 1, // Magic Guard
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_PSYCHIC, MOVE_FOCUS_BLAST, MOVE_THUNDER, MOVE_CALM_MIND
    },
    {
    .lvl = 3,
    .species = SPECIES_LUNATONE,
...
static const struct TrainerMonItemCustomMoves sParty_TabithaMossdeep[] = {
    ...
    .ability = 0, // Sheer Force
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FLARE_BLITZ, MOVE_ZEN_HEADBUTT, MOVE_ROCK_SLIDE, MOVE_METEOR_MASH
    },
    {
    .lvl = 2,
    .species = SPECIES_STEELIX,
...
static const struct TrainerMonItemCustomMoves sParty_CourtneyMossdeep[] = {
    ...
    .ability = 2, // Drought
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FLAMETHROWER, MOVE_SHADOW_BALL, MOVE_SOLAR_BEAM, MOVE_WILL_O_WISP
    },
    {
    .lvl = 0, 
    .species = SPECIES_KROOKODILE,
    ...
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_HOUNDOOMINITE,
    .ability = 2, // Intimidate -> Solar Power
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
...
static const struct TrainerMonItemCustomMoves sParty_StevenMossdeep[] = {
    ...
    .ability = 1, // Intimidate -> Tough Claws
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
...
static const struct TrainerMonItemCustomMoves sParty_Archie[] = {
    ...
    .ability = 1, // Hydration
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_DRACO_METEOR, MOVE_MUDDY_WATER, MOVE_REST, MOVE_CURSE
    },
    {
    .lvl = 1,
    .species = SPECIES_TENTACRUEL,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .ability = 0, // Swift Swim
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_GIGA_DRAIN, MOVE_SCALD, MOVE_ICE_BEAM, MOVE_AURA_SPHERE
    },
    {
    .lvl = 1,
    .species = SPECIES_KABUTOPS,
    ...
    .ability = 0, // Swift Swim
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_WATERFALL, MOVE_STONE_EDGE, MOVE_LEECH_LIFE, MOVE_SWORDS_DANCE
    },
    {
    .lvl = 1,
    .species = SPECIES_LAPRAS,
    ...
    .ability = 2, // Hydration
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SCALD, MOVE_FREEZE_DRY, MOVE_THUNDERBOLT, MOVE_PSYCHIC
    },
    {
    .lvl = 1,
    .species = SPECIES_SWAMPERT,
    ...
    .ability = 0, // Swift Swim
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_SCALD, MOVE_HURRICANE, MOVE_DRACO_METEOR, MOVE_FLASH_CANNON  
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan2[] = { // singles
    ...
    .ability = 0, // Swift Swim
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_LEAF_STORM, MOVE_SCALD, MOVE_ICE_BEAM, MOVE_AURA_SPHERE
    },
    {
    .lvl = 0,
    .species = SPECIES_KABUTOPS,
...
static const struct TrainerMonItemCustomMoves sParty_Juan3[] = { // Doubles
    ...
    .ability = 0, // Swift Swim
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_LEAF_STORM, MOVE_SURF, MOVE_ICE_BEAM, MOVE_AURA_SPHERE
    },
    {
    .lvl = 0,
    .species = SPECIES_GASTRODON_EAST_SEA,
    ...
    .ability = 1, // Storm Drain
    .spread = SPREAD_31_IV_HP_SPDEF_CAREFUL,
    .moves = MOVE_WATERFALL, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_RECOVER
    },
    {
    .lvl = 0,
    .species = SPECIES_LAPRAS,
...
static const struct TrainerMonItemCustomMoves sParty_Juan5[] = { // doubles legendaries
    ...
    .ability = 0, // Swift Swim
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_LEAF_STORM, MOVE_MUDDY_WATER, MOVE_ICE_BEAM, MOVE_AURA_SPHERE
    },
    {
    .lvl = 0,
    .species = SPECIES_GASTRODON_EAST_SEA,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .ability = 0, // Poison Touch
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_GUNK_SHOT, MOVE_KNOCK_OFF, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH
    },
    {
    .lvl = 1,
    .species = SPECIES_GRENINJA,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .ability = 1, // Mold Breaker
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_SHADOW_BALL, MOVE_FLAMETHROWER, MOVE_ENERGY_BALL, MOVE_PSYCHIC
    },
    {
    .lvl = 1,
    .species = SPECIES_DUSKNOIR,
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SHADOW_CLAW, MOVE_KNOCK_OFF, MOVE_PLAY_ROUGH, MOVE_COTTON_GUARD
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BLIZZARD, MOVE_MYSTICAL_FIRE, MOVE_CHARGE_BEAM, MOVE_SCALD
    },
    {
    .lvl = 2,
    .species = SPECIES_GLALIE,
...
static const struct TrainerMonItemCustomMoves sParty_LucyLavaridge[] = {
    ...
    .ability = 2, // Multiscale
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYDRO_PUMP, MOVE_MOONBLAST, MOVE_DRAGON_PULSE, MOVE_RECOVER
    },
    {
    .lvl = 0,
    .species = SPECIES_SERPERIOR,
...
static const struct TrainerMonItemCustomMoves sParty_SpenserFortree[] = {
    ...
    .ability = 2, // Reckless
    .spread = SPREAD_31_IV_ATK_SPEED_NAIVE,
    .moves = MOVE_OVERHEAT, MOVE_EXTREME_SPEED, MOVE_STRENGTH, MOVE_CRUNCH
    },
    {
    .lvl = 0,
    .species = SPECIES_LAPRAS,
    .heldItem = ITEM_LAPRASITE,
    .ability = 0, // Water Absorb -> Ice Body
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
...
static const struct TrainerMonItemCustomMoves sParty_Buffel[] = {
    ...
    .ability = 2, // Multiscale
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_SCALD, MOVE_MOONBLAST, MOVE_RECOVER, MOVE_TOXIC
    },
    {
    .lvl = 0,
    .species = SPECIES_HAXORUS,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney2[] = { // doubles
    ...
    .ability = 0, // Sand Stream
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_ROCK_SLIDE, MOVE_CRUNCH, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH
    },
    {
    .lvl = 1,
    .species = SPECIES_CACTURNE,
    ...
    .heldItem = ITEM_ABSOLITE,
    .spread = SPREAD_31_IV_ATK_SPEED_NAIVE,
    .moves = MOVE_KNOCK_OFF, MOVE_PLAY_ROUGH, MOVE_SURF, MOVE_CLOSE_COMBAT
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney3[] = { // legendaries
    ...
    .ability = 2, // Protean
    .spread = SPREAD_31_IV_SPATK_SPEED_HASTY,
    .moves = MOVE_SCALD, MOVE_ICE_BEAM, MOVE_EXTRASENSORY, MOVE_GUNK_SHOT
    },
    {
    .lvl = 1,
    .species = SPECIES_SCRAFTY,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney4[] = { // doubles legendaries
    ...
    .heldItem = ITEM_WIDE_LENS,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DARK_VOID, MOVE_DARK_PULSE, MOVE_SLUDGE_BOMB, MOVE_AURA_SPHERE
    },
    {
    .lvl = 1,
    .species = SPECIES_YVELTAL,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia2[] = { // Doubles
    ...
    .ability = 0, // Snow Warning
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BLIZZARD, MOVE_LEAF_STORM, MOVE_EARTH_POWER, MOVE_AURA_SPHERE
    },
    {
    .lvl = 1,
    .species = SPECIES_FROSLASS,
    ...
    .ability = 2, // Slush Rush
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BLIZZARD, MOVE_MYSTICAL_FIRE, MOVE_FREEZE_DRY, MOVE_MUDDY_WATER
    },
    {
    .lvl = 2,
    .species = SPECIES_GLALIE,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia3[] = { // legendaries
    ...
    .ability = 2, // Thick Fat
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FREEZE_DRY, MOVE_FUSION_FLARE, MOVE_DRACO_METEOR, MOVE_AURA_SPHERE
    },
    {
    .lvl = 1,
    .species = SPECIES_GLACEON,
...
static const struct TrainerMonItemCustomMoves sParty_Drake2[] = { // Doubles
    ...
    .ability = 2, // Adaptability
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SLUDGE_BOMB, MOVE_DRACO_METEOR, MOVE_AURA_SPHERE, MOVE_PROTECT
    },
    {
    .lvl = 1,
    .species = SPECIES_KOMMO_O,
...
static const struct TrainerMonItemCustomMoves sParty_Cynthia1[] = {
    ...
    .ability = 2, // Multiscale
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_SCALD, MOVE_MOONBLAST, MOVE_RECOVER, MOVE_MIRROR_COAT
    },
    {
    .lvl = 7,
    .species = SPECIES_GARCHOMP,
