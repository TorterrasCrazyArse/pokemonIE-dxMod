...
static const u8 sMagmaArmorDescription[] = _("Water and Cold protection.");
static const u8 sWaterVeilDescription[] = _("Prevents burns and shocking.");
...
static const u8 sSniperDescription[] = _("Boosts bullet moves.");
...
static const u8 sHeavyMetalDescription[] = _("Doubles weight and crushes.");
static const u8 sLightMetalDescription[] = _("Halves weight and ups Speed.");
...
static const u8 sVictoryStarDescription[] = _("Ups party's chances.");
...
static const u8 sMegaLauncherDescription[] = _("Boosts pulse and beam moves.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_HEAVY_METAL] = _("Heavy Weight"),
    [ABILITY_LIGHT_METAL] = _("Light Weight"),
