const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_COMET_PUNCH] = _("Mutli-Punch"),
    ...
    [MOVE_METEOR_MASH] = _("Meteor Punch"),
    ...
    [MOVE_SUCKER_PUNCH] = _("Cheap Shot"),
