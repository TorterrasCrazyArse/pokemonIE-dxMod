...
static const u8 sText_PointedStonesFloat[] =_("Pointed stones were thrown\naround {B_DEF_TEAM2} team's feet!");
...
static const u8 sText_HazardsCrushed[] = _("The rocks got crushed\nfrom around the team's feet!");
static const u8 sText_DampSlipped[] = _("{B_DEF_NAME_WITH_PREFIX} won't\nget trapped!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_HAZARDSCRUSHED - 12] = sText_HazardsCrushed,
    [STRINGID_DAMPSLIPPED - 12] = sText_DampSlipped,
};
